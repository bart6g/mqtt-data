...
class DatabaseManager():
    def __init__(self):
        self.conn = pymysql.connect(host, user, password, DB_Name)
...
def DHT22_Temp_Data_Handler(jsonData):
    ...
    dbObj.add_del_update_db_record("insert into DHT22_Temperature_Data (SensorID, Date_n_Time, Temperature) values (?,?,?)", [
